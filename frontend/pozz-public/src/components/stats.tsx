...
export function Stats() {
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      {/* Gradient Orbs */}
      <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-red-600/20 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-red-500/10 rounded-full blur-3xl" />
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="p-8 rounded-2xl bg-white/5 dark:bg-white/5 backdrop-blur-sm
                ...
                <div className="mb-4">
                  <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-red-500 to-red-600 bg-clip-text text-transparent mb-3
